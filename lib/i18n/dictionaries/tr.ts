const tr = {
  ...
  technical: {
    ...
    originalBadge: "TR",
    empty: "Henüz Teknik Analiz Yok",
    emptyHint: "İlk analiz bir sonraki işlem gününün açılışından önce yayımlanır.",
    notListed: "Bu Hisse Teknik Analiz Listesinde Yok",
    notListedHint: "Listedeki hisseler: {list}.",
    noAnalysis: "Bu Hisse İçin Henüz Analiz Yok",
  },
