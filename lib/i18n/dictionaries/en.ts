...
const en: typeof tr = {
  ...
  technical: {
    ...
    originalBadge: "TR",
    empty: "No Technical Analysis Yet",
    emptyHint: "The first analysis is published before the next trading day's open.",
    notListed: "This Stock Is Not on the Technical List",
    notListedHint: "Stocks on the list: {list}.",
