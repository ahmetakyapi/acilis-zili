/**
 * Endeks bileşen listeleri — Piyasalar sayfasının veri tabanı.
 *
 ...
 * aynı kaynaktan yeniden üretilir. Fiyat/veri BURADAN GELMEZ — yalnızca
 * üyelik listesi ve görünen ad statiktir, kotasyonlar canlı sağlayıcıdan gelir.
 */

export type IndexMember = { symbol: string; name: string };
...
export const DOW_MEMBERS: IndexMember[] = [
  ...
  { symbol: "HON", name: "Honeywell Technologies" },
  { symbol: "IBM", name: "IBM" },
...
export const NDX_MEMBERS: IndexMember[] = [
  ...
  { symbol: "TRI", name: "Thomson Reuters" },
...
export const SPX_MEMBERS: IndexMember[] = [
  ...
  { symbol: "FDXF", name: "FedEx Freight" },
  ...
  { symbol: "HON", name: "Honeywell Technologies" },
  { symbol: "HONA", name: "Honeywell Aerospace" },
